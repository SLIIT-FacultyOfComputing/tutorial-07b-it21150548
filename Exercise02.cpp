...
int main() {
  // ========= DO NOT CHANGE THE INPUT CODE BELOW ==================
   int length, width, radius;//the names are the same but theyre not the same variables as the header file variables, we cant access rpivate header file variables through the main program!
